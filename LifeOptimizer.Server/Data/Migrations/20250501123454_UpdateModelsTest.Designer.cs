...
namespace LifeOptimizer.Server.Data.Migrations
{
    ...
    [Migration("20250501123454_UpdateModelsTest")]
    partial class UpdateModelsTest
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LifeOptimizer.Server.Models.Shelf", b =>
                {
                    ...
                    b.HasOne("LifeOptimizer.Server.Models.StorageItem", null)
                        .WithMany("Shelves")
                        .HasForeignKey("StorageItemId1");
