...
- Create Angular project with ng: `ng new lifeoptimizer.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`lifeoptimizer.client.esproj`).
